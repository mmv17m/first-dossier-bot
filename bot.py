...
async def help(ctx):
	...
	await ctx.send("**инфа member** - показывает иформацию об учаснике\n**заменить member новое значение(в кавычках)** - заменяет известную информацию на новое значение\n**добавить member новая информация(в кавычках)** - дописывает новую информацию в конце уже известной ")
